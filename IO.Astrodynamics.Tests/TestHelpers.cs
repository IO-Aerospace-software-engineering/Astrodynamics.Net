...
namespace IO.Astrodynamics.Models.Tests
{
    internal class TestHelpers
    {
        ...
        internal CelestialBodyScenario GetMarsAtJ2000()
        {
            ...
            Scenario scenario = new Scenario("scn1", mission,new Window(new DateTime(2021, 1, 1), new DateTime(2021, 1, 2)));
            CelestialBody moon = new CelestialBody(499, "mars", 4.2828E+4, 3376.2, 3396.2);
            return new CelestialBodyScenario(moon, new StateVector(new Vector3(208048140.64184200, 209619.17353881, -5529162.31315533), new Vector3(1.16267240, 23.91840970, 10.93917192), GetSun(), new DateTime(2000, 1, 1, 12, 0, 0), Frames.Frame.ICRF), scenario);
        }
    }
}
