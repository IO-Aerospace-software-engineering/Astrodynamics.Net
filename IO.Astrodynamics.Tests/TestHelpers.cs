...
namespace IO.Astrodynamics.Tests
{
    internal static class TestHelpers
    {
        ...
        internal static CelestialBody EarthAtJ2000 => new(PlanetsAndMoons.EARTH, Frames.Frame.ICRF, new DateTime(2000, 1, 1, 12, 0, 0), atmosphericModel: new EarthAtmosphericModel());
