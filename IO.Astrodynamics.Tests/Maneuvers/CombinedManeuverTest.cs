...
namespace IO.Astrodynamics.Models.Tests.Maneuvers
{
    public class CombinedManeuverTest
    {
        ...
        public void CanExecute()
        {
            ...
            var earlyOrbit = new KeplerianElements(150000000.0, 0.0, 0.0, 0.0, 0.0, Constants.PI, sunScn, new DateTime(2020, 12, 31), Frames.Frame.ECLIPTIC);
            Assert.False(maneuver.CanExecute(earlyOrbit));

            var atTimeOrbit = new KeplerianElements(150000000.0, 0.0, 0.0, 0.0, 0.0, Constants.PI, sunScn, new DateTime(2021, 01, 02), Frames.Frame.ECLIPTIC);
            Assert.True(maneuver.CanExecute(atTimeOrbit));

            var overToleranceOrbit = new KeplerianElements(150000000.0, 0.0, 0.0, 0.0, 0.0, Constants.PI + 0.1, sunScn, new DateTime(2021, 01, 02), Frames.Frame.ECLIPTIC);
        ...
        public void ExecuteIncreasePerigee()
        {
            ...
            var ke = new KeplerianElements(24421.0, 0.726546824, 28.5 * Constants.Deg2Rad, 0.0, 0.0, 0.0, earthScn, new DateTime(2021, 01, 01), Frames.Frame.ICRF);
            Clock clk1 = new Clock("My clock", 1.0 / 256.0);
            Payload pl1 = new Payload("pl1", 300);
            Spacecraft spc1 = new Spacecraft(-1001, "My spacecraft", 1000.0);
            FuelTank fuelTank10 = new FuelTank("My fuel tank10", "ft2021", 4000.0);
            ...
            var orbit = new KeplerianElements(24421.0, 0.726546824, 28.5 * Constants.Deg2Rad, 0.0, 0.0, Constants.PI, earthScn, new DateTime(2021, 01, 01), Frames.Frame.ICRF);
