...
namespace IO.Astrodynamics.Models.Tests.Maneuvers
{
    public class ApsidalAlignmentManeuevrTests
    {
        ...
        public void CanExecuteAtP()
        {
            ...
            var ke = new KeplerianElements(15000.0, 0.33333, 0.0, 0.0, 0.0, 0.0, earthScn, new DateTime(2021, 01, 01), Frames.Frame.ICRF);
            Clock clk1 = new Clock("My clock", 1.0 / 256.0);
            Payload pl1 = new Payload("pl1", 300);
            Spacecraft spc1 = new Spacecraft(-1001, "My spacecraft", 1000.0);
            FuelTank fuelTank10 = new FuelTank("My fuel tank10", "ft2021", 4000.0);
            ...
            var targetOrbit = new KeplerianElements(18000.0, 0.5, 0.0, 0.0, 30.0 * Constants.Deg2Rad, 0.0, earthScn, new DateTime(2021, 01, 01), Frames.Frame.ICRF);
            ApsidalAlignmentManeuver maneuver = new ApsidalAlignmentManeuver(sc, new DateTime(2021, 1, 1), TimeSpan.FromDays(1.0), targetOrbit, sc.Engines.ToArray());

            var orbit = new KeplerianElements(15000.0, 0.33333, 0.0, 0.0, 0.0, ke.MeanAnomaly(156.41 * Constants.Deg2Rad), earthScn, new DateTime(2021, 01, 01), Frames.Frame.ICRF);
        ...
        public void CanExecuteAtQ()
        {
            ...
            var orbit = new KeplerianElements(15000.0, 0.33333, 0.0, 0.0, 0.0, ke.MeanAnomaly(341.77 * Constants.Deg2Rad), earthScn, new DateTime(2021, 01, 01), Frames.Frame.ICRF);
            Assert.True(maneuver.CanExecute(orbit));
        ...
        public void ExecuteAtQ()
        {
            ...
            Assert.Equal(new Vector3(-1.3687011626051788, 0.4981115087917445, 0.0), maneuver.DeltaV);
        }
    }
}