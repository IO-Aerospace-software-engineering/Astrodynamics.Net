...
namespace IO.Astrodynamics.Models.Tests.Integrator
{
    public class VVIntegratorTests
    {
        ...
        public void IntegrateGravity()
        {
            ...
            earthScn.AddStateVector(new StateVector(new Vector3(-2.679537555216521E+07, 1.327011135216045E+08, 5.752533467064925E+07), new Vector3(2.976558008982104E+01, -5.075339952746913E+00, -2.200929976753953E+00), sunScn, new DateTime(2021, 1, 1).AddSeconds(1.0), IO.Astrodynamics.Models.Frames.Frame.ICRF));
            moonScn.AddStateVector(new StateVector(new Vector3(2.068864826237993E+05, 2.891146390982051E+05, 1.515746884380044E+05), new Vector3(-8.366764389833921E-01, -5.602543663174073E-01, -1.710459390585548E-01), earthScn, new DateTime(2021, 1, 1).AddSeconds(1.0), IO.Astrodynamics.Models.Frames.Frame.ICRF));
