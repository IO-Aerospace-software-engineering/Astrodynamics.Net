    ...
    public class InstrumentTests
    {
        ...
        public async Task FindWindowInFieldOfView()
        {
            ...
            Spacecraft spacecraft =
                new Spacecraft(-179, "SC179", 1000.0, 10000.0, clock, parkingOrbit);
