...
namespace IO.Astrodynamics.Tests.Surface
{
    public class LaunchSiteTests
    {
        ...
        public void Create()
        {
            LaunchSite site = new LaunchSite(33,"l1", TestHelpers.EarthAtJ2000, new Geodetic(1.0, 2.0, 3.0), new AzimuthRange(1.0, 2.0));
        ...
        {
            LaunchSite site = new LaunchSite(33,"l1", TestHelpers.EarthAtJ2000, new Geodetic(1.0, 2.0, 3.0),new AzimuthRange(1.0, 2.0), new AzimuthRange(4.0, 5.0));
