...
namespace IO.Astrodynamics.Tests.Surface
{
    public class LaunchSiteTests
    {
        ...
        public void Create()
        {
            LaunchSite site = new LaunchSite(33,"l1", TestHelpers.EarthAtJ2000, new Planetocentric(1.0, 2.0, 3.0), new AzimuthRange(1.0, 2.0));
            Assert.Equal("l1", site.Name);
            Assert.Equal(TestHelpers.EarthAtJ2000, site.Body);
            Assert.Equal(new Planetocentric(1.0, 2.0, 3.0), site.Planetocentric);
        ...
        {
            LaunchSite site = new LaunchSite(33,"l1", TestHelpers.EarthAtJ2000, new Planetocentric(1.0, 2.0, 3.0),new AzimuthRange(1.0, 2.0), new AzimuthRange(4.0, 5.0));
