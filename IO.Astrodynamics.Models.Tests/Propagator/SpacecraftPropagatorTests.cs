...
namespace IO.Astrodynamics.Models.Tests.Propagator
{
    public class SpacecraftPropagatorTests
    {
        ...
        public void Create()
        {
            ...
            CelestialBodyScenario earthScn = new CelestialBodyScenario(earth,
                new StateVector(new Vector3(-2.679537555216521E+07, 1.327011135216045E+08, 5.752533467064925E+07),
                    new Vector3(2.976558008982104E+01, -5.075339952746913E+00, -2.200929976753953E+00), sunScn, new DateTime(2021, 1, 1), IO.Astrodynamics.Models.Frame.Frame.ICRF), scenario);
            ...
            CelestialBodyScenario moonScn = new CelestialBodyScenario(moon,
                new StateVector(new Vector3(2.068864826237993E+05, 2.891146390982051E+05, 1.515746884380044E+05),
                    new Vector3(-8.366764389833921E-01, -5.602543663174073E-01, -1.710459390585548E-01), earthScn, new DateTime(2021, 1, 1), IO.Astrodynamics.Models.Frame.Frame.ICRF), scenario);
        ...
        public void Propagate()
        {
            ...
            var sv = new StateVector(new Vector3(6800.0, 0.0, 0.0), new Vector3(0.0, 8.0, 0.0), earthScn, start, IO.Astrodynamics.Models.Frame.Frame.ICRF);
            Clock clk1 = new Clock("My clock", 1.0 / 256.0);
            Spacecraft spc1 = new Spacecraft(-1001, "My spacecraft", 1000.0);
        ...
        public void PropagateWithManeuver()
        {
            ...
            KeplerianElements originalOrbit =
                new KeplerianElements(6800.0, 0.0, 0.0 * Constants.Deg2Rad, 0.0, 0.0, 0.0, earthScn, scenario.Window.StartDate, IO.Astrodynamics.Models.Frame.Frame.ICRF);
            KeplerianElements targetOrbit =
                new KeplerianElements(6800.0, 0.0, 2.0 * Constants.Deg2Rad, 0.0, 0.0, 0.0, earthScn, scenario.Window.StartDate, IO.Astrodynamics.Models.Frame.Frame.ICRF);
