...
namespace IO.Astrodynamics.Models.Tests.Coordinates
{
    public class EquatorialTests
    {
        ...
        public void CreateFromStateVector()
        {
            ...
            Equatorial eq = new Equatorial(new StateVector(new IO.Astrodynamics.Models.Math.Vector3(-291608.38463344, -266716.83339423, -76102.48709990), new IO.Astrodynamics.Models.Math.Vector3(), earthScn, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF));
        ...
        public void CreateFromStateVector2()
        {
            ...
            var eq = new Equatorial(new StateVector(new Vector3(-202831.34150844064, 284319.70678317308, 150458.88140126597), new Vector3(-0.48702480142667454, -0.26438331399030518, -0.17175837261637006), earth, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF));
