...
namespace IO.Astrodynamics.Models.Tests.Maneuvers
{
    public class LaunchTests
    {
        ...
        public void CreateWithBody()
        {
            ...
            LaunchSite site = new LaunchSite("l1", th.GetEarthAtJ2000(), new IO.Astrodynamics.Models.Coordinates.Geodetic(1.0, 2.0, 3.0), default, new IO.Astrodynamics.Models.Coordinates.AzimuthRange(1.0, 2.0));
            Site recoverySite = new Site("l2", th.GetEarthAtJ2000(), new IO.Astrodynamics.Models.Coordinates.Geodetic(1.0, 2.0, 3.0));
        ...
        public void InertialAscendingAzimuth()
        {
            ...
            var th = new TestHelpers();
            LaunchSite site = new LaunchSite("l1", th.GetEarthAtJ2000(), new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0), default, new IO.Astrodynamics.Models.Coordinates.AzimuthRange(0.0, 6.0));
            Site recoverySite = new Site("l2", th.GetEarthAtJ2000(), new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0));
            Launch launch = new Launch(site, recoverySite, new IO.Astrodynamics.Models.OrbitalParameters.KeplerianElements(6728.137, 0.0, 51.6494 * Constants.Deg2Rad, 0.0, 0.0, 0.0, th.GetEarthAtJ2000(), epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), Constants.CivilTwilight, null);
        ...
        public void RetrogradInertialAscendingAzimuth()
        {
            ...
            LaunchSite site = new LaunchSite("l1", th.GetEarthAtJ2000(), new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0), default, new IO.Astrodynamics.Models.Coordinates.AzimuthRange(0.0, 6.0));
            Site recoverySite = new Site("l2", th.GetEarthAtJ2000(), new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0));
            Launch launch = new Launch(site, recoverySite, new IO.Astrodynamics.Models.OrbitalParameters.KeplerianElements(6728.137, 0.0, 110.0 * Constants.Deg2Rad, 0.0, 0.0, 0.0, th.GetEarthAtJ2000(), epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), Constants.CivilTwilight, null);
            var res = launch.GetInertialAscendingAzimuthLaunch(epoch);
        ...
        public void RetrogradNonInertialInsertionVelocity()
        {
            ...
            LaunchSite site = new LaunchSite("l1", th.GetEarthAtJ2000(), new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0), default, new IO.Astrodynamics.Models.Coordinates.AzimuthRange(0.0, 6.0));
            Site recoverySite = new Site("l2", th.GetEarthAtJ2000(), new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0));
            Launch launch = new Launch(site, recoverySite, new IO.Astrodynamics.Models.OrbitalParameters.KeplerianElements(6728.137, 0.0, 140.0 * Constants.Deg2Rad, 0.0, 0.0, 0.0, th.GetEarthAtJ2000(), epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), Constants.CivilTwilight, null);
            var res = launch.GetNonInertialInsertionVelocity(epoch);
        ...
        public void FindLaunchWindows()
        {
            ...
            earth.AddStateOrientationFromICRF(new IO.Astrodynamics.Models.OrbitalParameters.StateOrientation(new IO.Astrodynamics.Models.Math.Quaternion(0.57445446, 0.00084188, -0.00058582, 0.81853590), new IO.Astrodynamics.Models.Math.Vector3(1.51823816E-07, -3.60693290E-10, 7.29209921E-05), epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF));
            LaunchSite site = new LaunchSite("l1", earth, new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0), default, new IO.Astrodynamics.Models.Coordinates.AzimuthRange(0.0, 6.0));
            Site recoverySite = new Site("l2", earth, new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0));
            //ISS at 2021-06-02 TDB
            Launch launch = new Launch(site, recoverySite, new IO.Astrodynamics.Models.OrbitalParameters.StateVector(new IO.Astrodynamics.Models.Math.Vector3(-1.144243683349977E+03, 4.905086030671815E+03, 4.553416875193589E+03), new IO.Astrodynamics.Models.Math.Vector3(-5.588288926819989E+00, -4.213222250603758E+00, 3.126518392859475E+00), earth, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), Constants.CivilTwilight, null);
            var res = launch.FindLaunchWindows(new IO.Astrodynamics.Models.Time.Window(epoch, TimeSpan.FromDays(1.0)));
        ...
        public void FindLaunchWindowsByDay()
        {
            ...
            Site recoverySite = new Site("l2", earth, new IO.Astrodynamics.Models.Coordinates.Geodetic(-81.0 * Constants.Deg2Rad, 28.5 * Constants.Deg2Rad, 0.0));
            //ISS at 2021-06-02 TDB
            Launch launch = new Launch(site, recoverySite, new IO.Astrodynamics.Models.OrbitalParameters.StateVector(new IO.Astrodynamics.Models.Math.Vector3(-1.144243683349977E+03, 4.905086030671815E+03, 4.553416875193589E+03), new IO.Astrodynamics.Models.Math.Vector3(-5.588288926819989E+00, -4.213222250603758E+00, 3.126518392859475E+00), earth, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), Constants.CivilTwilight, true);
            var res = launch.FindLaunchWindows(new IO.Astrodynamics.Models.Time.Window(epoch, TimeSpan.FromDays(1.0)));
            Assert.Single(res);
            var firstWindow = res[0];
        ...
        public void FindSouthLaunchWindowsByDay()
        {
            ...
            var earth = th.GetEarth();
            earth.AddStateOrientationFromICRF(new IO.Astrodynamics.Models.OrbitalParameters.StateOrientation(new IO.Astrodynamics.Models.Math.Quaternion(0.57445446, 0.00084188, -0.00058582, 0.81853590), new IO.Astrodynamics.Models.Math.Vector3(1.51823816E-07, -3.60693290E-10, 7.29209921E-05), epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF));
            LaunchSite site = new LaunchSite("l1", earth, new IO.Astrodynamics.Models.Coordinates.Geodetic(-104.0 * Constants.Deg2Rad, -41.0 * Constants.Deg2Rad, 0.0), default, new IO.Astrodynamics.Models.Coordinates.AzimuthRange(0.0, 6.0));
            Site recoverySite = new Site("l2", earth, new IO.Astrodynamics.Models.Coordinates.Geodetic(-104.0 * Constants.Deg2Rad, -41.0 * Constants.Deg2Rad, 0.0));
            //ISS at 2021-06-02 TDB
            Launch launch = new Launch(site, recoverySite, new IO.Astrodynamics.Models.OrbitalParameters.StateVector(new IO.Astrodynamics.Models.Math.Vector3(-1.144243683349977E+03, 4.905086030671815E+03, 4.553416875193589E+03), new IO.Astrodynamics.Models.Math.Vector3(-5.588288926819989E+00, -4.213222250603758E+00, 3.126518392859475E+00), earth, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), Constants.CivilTwilight, true);
            var res = launch.FindLaunchWindows(new IO.Astrodynamics.Models.Time.Window(epoch, TimeSpan.FromDays(1.0)));
            Assert.Single(res);
