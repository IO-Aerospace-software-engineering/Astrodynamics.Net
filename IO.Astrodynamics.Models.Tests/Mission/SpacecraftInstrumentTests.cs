...
namespace IO.Astrodynamics.Models.Tests.Mission
{
    public class SpacecraftInstrumentTests
    {
        ...
        public void IsInFieldOfView()
        {
            ...
            var sv = new StateVector(new Vector3(a, 0.0, 0.0), new Vector3(0.0, v, 0.0), earth, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF);
            ...
            sc.AddStateOrientationFromICRF(new StateOrientation(Quaternion.Zero, Vector3.Zero, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF));
