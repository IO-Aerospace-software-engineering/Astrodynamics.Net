...
namespace IO.Astrodynamics.Models.Tests.Mission
{
    public class CelestialBodyScenarioTests
    {
        ...
        public void RelativeStateVectorSatellites()
        {
            ...
            Assert.Equal(new StateVector(new Vector3(-206886.4826237993, 289114.63909820508, 151574.68843800441), new Vector3(-0.83667643898339206, -0.56025436631740733, -0.17104593905855481), earth, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), sv);
        }
        ...
        public void RelativeStateVectorSibling()
        {
            ...
            var sv = new StateVector(new Vector3(6800.0, 0.0, 0.0), new Vector3(0.0, 8.0, 0.0), earth, new DateTime(2021, 1, 1), IO.Astrodynamics.Models.Frame.Frame.ICRF);
        ...
        public void RelativeStateVectorSun()
        {
            ...
            Assert.Equal(new StateVector(new Vector3(-27002262.034789011, 132990228.16070271, 57676909.359087259), new Vector3(-30.602256528804432, -5.63559431906432, -2.371975915812508), sun, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), res);
        }
        ...
        public void RelativeStateVectorOtherBranch()
        {
            ...
            Assert.Equal(new StateVector(new Vector3(119883897.84258185, 55016482.438638419, 26051146.221691012), new Vector3(9.43567384880443, 16.363385989064319, 7.8636912558125083), sun, epoch, IO.Astrodynamics.Models.Frame.Frame.ICRF), res);
        }
        ...
        public void IsOcculted()
        {
            ...
            Assert.True(res == OccultationType.Partial);
        ...
        public void FindOccultationsEclipse()
        {
            ...
            Assert.Equal(OccultationType.None, res[0].OccultationType);
            ...
            Assert.Equal(OccultationType.Partial, res[1].OccultationType);
            ...
            Assert.Equal(OccultationType.None, res[2].OccultationType);
