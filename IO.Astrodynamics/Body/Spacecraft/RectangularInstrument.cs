...
public class RectangularInstrument : Instrument
{
    ...
    {
        await using var stream = this.GetType().Assembly.GetManifestResourceStream("IO.Astrodynamics.Templates.InstrumentKernelRectangularTemplate.ti");
