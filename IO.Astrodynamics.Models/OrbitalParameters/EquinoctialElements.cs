...
namespace IO.Astrodynamics.Models.OrbitalParameters
{
    public class EquinoctialElements : OrbitalParameters, IEquatable<EquinoctialElements>
    {
        ...
        /// <returns></returns>
        public EquinoctialElements(double p, double f, double g, double h, double k, double l0, CelestialBodyScenario centerOfMotion, DateTime epoch, Frame.Frame frame) : base(centerOfMotion, epoch, frame)
        {
            P = p;
            F = f;
            G = g;
