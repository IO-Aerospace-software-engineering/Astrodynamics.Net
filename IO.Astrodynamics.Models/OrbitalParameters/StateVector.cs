...
namespace IO.Astrodynamics.Models.OrbitalParameters
{
    public class StateVector : OrbitalParameters, IEquatable<StateVector>
    {
        ...
        StateVector() : base() { }
        public StateVector(Vector3 position, Vector3 velocity, CelestialBodyScenario centerOfMotion, DateTime epoch, Frame.Frame frame) : base(centerOfMotion, epoch, frame)
        {
            Position = position;
            Velocity = velocity;
        }
