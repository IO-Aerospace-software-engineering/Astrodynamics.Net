...
{
    public class Site : Entity, ILocalizable
    {
        ...
        public Site(string name, CelestialBodyScenario body, in Geodetic geodetic, int id = default) : base(id)
        {
        ...
        {
            var angle = GetEphemeris(Frame.Frame.ICRF, epoch).Position.Inverse().Angle(RelativeStateVector(Frame.Frame.ICRF, GetSun(), epoch).Position);
