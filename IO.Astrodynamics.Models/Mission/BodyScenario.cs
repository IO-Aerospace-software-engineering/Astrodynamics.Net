...
namespace IO.Astrodynamics.Models.Mission
{
    public abstract class BodyScenario : Entity, IEquatable<BodyScenario>, ILocalizable
    {
        ...
        public OccultationType IsOcculted(BodyScenario by, ILocalizable observer, in DateTime epoch)
        {
            ...
            var targetPosition = observer.RelativeStateVector(IO.Astrodynamics.Models.Frame.Frame.ICRF, this, epoch)
                .Position;
            var byPosition = observer.RelativeStateVector(IO.Astrodynamics.Models.Frame.Frame.ICRF, by, epoch).Position;
